...
\newcommand{\duedate}{July 15, 2026 at 23:59 (UTC+4)}
...
\begin{itemize}
  \item \warn{−5 points} for the tire team if the contribution report is missing or submitted late.
...
\end{itemize}
\end{warnbox}
The contribution report will be considered a mandatory part of the project deliverables. It will also be used during the defense to guide questions about individual understandinof each module.
% =====================================================================
